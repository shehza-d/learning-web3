...
const AuthContextProvider = ({ children }: { children: ReactNode }) => {
    ...
    const sign_In = async (signer: any) => {
        ...
        try {
            ...
            dispatch({
                type: "setUser",
                payload: { address: userAddress, isError: false, loading: false, signer: signer },
            });
        } catch (e) {
            dispatch({
                type: "setUser",
                payload: { address: undefined, isError: true, loading: false, signer: undefined },
            });
        }
    };
    ...
    const signout = () => {
        disconnectWallet().then(() =>
            dispatch({ type: "setUser", payload: { ...initialState, loading: false } }),
        );
        return null;
    };
