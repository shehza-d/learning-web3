                    ...
                    <div className="container mx-auto xl:px-6">
                        <div className="grid lg:grid-cols-2 gap-12  items-center">
                            <div className="mt-12 lg:mt-0">
                                <h1 className="text-4xl sm:text-5xl md:text-6xl xl:text-6xl text-black font-bold tracking-tight sm:!leading-[68px] mb-4 capitalize">
                                    {" "}
                                    Ecommerce Platform for buyers, sellers & retailers
                                </h1>
                            </div>
