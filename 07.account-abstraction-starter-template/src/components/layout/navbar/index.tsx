        ...
        <nav className="w-full py-5 px-0.5 sm:px-4 lg:px-20 z-50 fixed top-0 bg-[#E3E3E3] shadow">
            <div className="px-4 lg:px-0 mx-auto block lg:flex flex-wrap lg:flex-nowrap items-center">
                <div className="flex items-center justify-between flex-wrap">
                    ...
                    <div className="flex lg:hidden items-center ">
                        ...
                        <button
                            ...
                            className=" p-1.5 nav-btn dark:bg-white bg-white rounded-full text-2xl dark:text-black outline-none dark:hover:bg-steelBlue-200  dark:hover:text-white focus:outline-none "
                ...
                <div
                    className={`${
                        isOpen
                            ? "absolute translate-x-0 opacity-100"
                            : "hidden opacity-0 -translate-x-full"
                    }  lg:relative inset-x-0 z-20 w-full pt-8 lg-pt-0 px-0 md:px-1.5 rounded-b-xl lg:rounded-none lg:space-y-0 lg:px-0 py-4 bg-white shadow lg:shadow-none dark:bg-darkSlateBlue dark:lg:bg-transparent lg:mt-0 lg:p-0 top-20 lg:top-0 lg:bg-transparent lg:w-auto lg:opacity-100 lg:translate-x-0  min-h-full lg:flex lg:items-center lg:justify-between lg:flex-1 justify-between `}
                >
